...
@EnableSilverTestEnv
class ManagedBeanParameterTest {

  private final ManagedBeanProvider beanProvider = ManagedBeanProvider.getInstance();

  @Test
  void theBeanIsWellInjected(@TestManagedBean MyBean1 myBean1, @TestManagedBean MyBean2 myBean2) {
    ...
    assertThat(myBean2.getMyBean().getFoo(), is(MyBean1.DEFAULT_FOO));
  }

  @Test
  void theBeanIsManagedInTheBeanContainer(@TestManagedBean MyBean1 myBean1, @TestManagedBean MyBean2 myBean2) {
