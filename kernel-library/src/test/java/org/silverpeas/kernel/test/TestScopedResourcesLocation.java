...
/**
 * Implementation of the {@link SilverpeasResourcesLocation} interface to be used in the scope of a
 * unit test.
 *
 * @author mmoquillon
 */
public class TestScopedResourcesLocation implements SilverpeasResourcesLocation {
