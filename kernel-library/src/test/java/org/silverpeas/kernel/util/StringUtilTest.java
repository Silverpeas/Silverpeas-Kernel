...
class StringUtilTest {
  ...
  @Test
  void defaultStringIfNotDefinedReturningEmptyStringAsDefault() {
  ...
  @Test
  void defaultStringIfNotDefinedReturningGivenStringAsDefault() {
  ...
  void likeIgnoreCaseWithWildcardAny() {
    ...
    assertThat(StringUtil.likeIgnoreCase("%%%toTo",
        "\\%\\%\\%%%%%%%%%%%%%%%%%Ot%%%%%%%%%%%%%%%%%%"), is(true));
    assertThat(StringUtil.likeIgnoreCase("%%%La petite maison", "\\%\\%\\%LA PETITE MAISON"),
        is(true));
    ...
    assertThat(StringUtil.likeIgnoreCase("&é\"\\m\\p\\a'(-è_ç^à@)°]+=}$£¤^¨*µù\\%!§:/;.,?<>",
        "&é\"\\m\\p\\a'(-è_ç^à@)°]+=}$£¤^¨*µù\\\\%!§:/;.,?<>"), is(true));
  }
  ...
  void likeIgnoreCaseWithWildcardOneCharacter() {
    ...
    assertThat(StringUtil.likeIgnoreCase("___La petite maison", "\\_\\_\\_LA PETITE MAISON"),
        is(true));
    ...
    assertThat(StringUtil.likeIgnoreCase("&é\"\\m\\p\\a'(-è_ç^à@)°]+=}$£¤^¨*µù\\_!§:/;.,?<>",
        "&é\"\\m\\p\\a'(-è_ç^à@)°]+=}$£¤^¨*µù\\\\_!§:/;.,?<>"), is(true));
  }
