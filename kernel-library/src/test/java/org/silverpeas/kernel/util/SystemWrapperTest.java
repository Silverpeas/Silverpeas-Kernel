...
class SystemWrapperTest {
  ...
  void getInstanceLoadsInstanceBySPI() {
    SystemWrapper instance = SystemWrapper.getInstance();
    assertThat(instance, notNullValue());
    assertThat(instance, instanceOf(TestScopedSystemWrapper.class));
  }

  @Test
  @DisplayName("The SystemWrapper class is a singleton")
  void theSilverpeasResourcesProviderIsASingleton() {
    SystemWrapper instance = SystemWrapper.getInstance();
    SystemWrapper another = SystemWrapper.getInstance();
