 ...
 * functional module in Silverpeas. Each setting in the bundle is defined as a key-value pair.
 * <p>
 ...
 * @apiNote A general resource bundle is expected at {@link SettingBundle#GENERAL_BUNDLE_NAME}
 * @see ResourceBundle
 * @author mmoquillon
 */
public class SettingBundle implements SilverpeasBundle {
  ...
  /**
   * The Silverpeas settings bundle for general configuration properties. It is both the default
   * and base bundle that has to be provided and available for Silverpeas.
   */
