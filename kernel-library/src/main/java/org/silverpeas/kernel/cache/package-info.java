 ...
 */
/**
 * Provides an API to manage caches whatever their implementation. A cache is an efficient way to
 * store objects in order to retrieve them later without having to get them from an external
